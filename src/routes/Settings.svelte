...
<main in:fade={{ duration: 100 }}>
    ...
    <p class="subtitle">Configure basic permanent settings of the connected LUCIDAC device</p>

    <nav class="level">
        <div class="level-left">
            <p class="level-item"><button class="button is-primary">Apply & Reboot</button></p>
            <p class="level-item"><button class="button">Undo changes</button></p>
        </div>
        <div class="level-right">
            <p class="level-item"><button class="button">Reset to factory settings</button></p>
        </div>
    </nav>
    <!--
    <p>
